...
from ultralytics.nn.Addmodules.HG_WTConv import HG_ResLayer, HG_WTConv
from ultralytics.nn.Addmodules.MRFEM import MRFEM
from ultralytics.nn.Addmodules.ODAM import ODAM
from ultralytics.nn.Addmodules.SFM_ResLayer import SFM_ResLayer
from ultralytics.nn.Addmodules.SPDConv import SPDConv
from ultralytics.nn.Addmodules.UpSample import UpSample
from ultralytics.nn.Addmodules.ResNet import ConvNormLayer
...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        elif m in {HG_ResLayer, SFM_ResLayer}:
            c1 = ch[f]
            c2_base = args[0]
            e = args[3] if len(args) > 3 else 4
            c2 = c2_base * e
            args = [c1, c2_base, *args[1:]]
            args.insert(4, n)
            n = 1
        elif m is ODAM:
            c2 = ch[f]
